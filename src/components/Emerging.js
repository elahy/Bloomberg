...
function Emerging() {
  return (
    <div
      style={{
        backgroundImage: "url(/img/emerging.webp)",
    ...
    >
      <div>
        <p className="text-bd font-bold px-96 py-20 text-white">
          ...
          businesses, stable conditions for startups to flourish and rapid
          gigitalization make it one of the most promising emerging markets.
        </p>
      </div>
    </div>
  );

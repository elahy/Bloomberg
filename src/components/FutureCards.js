...
function FutureCards() {
  return (
    <div className="bg-light-green">
      <div>
        <h1 className="text-bd-green text-center pt-4 xl:py-40 px-4 xl:px-96 xl:mx-40 text-4xl xl:text-bd font-bold">
          Explore the Future of Opportunity in Bangladesh:
        </h1>
      </div>
      <div className="inline xl:flex mx-96 justify-center pb-40">
